...
class SettingTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        if (!keyExist('email')) {
            Setting::create(['key' => 'email', 'value' => 'support@hitech.mm']);
        }

        if (!keyExist('company_name')) {
            Setting::create(['key' => 'company_name', 'value' => 'Hi Tech']);
        }
        ...
        if (!keyExist('developed')) {
            Setting::create(['key' => 'developed', 'value' => 'Hi Tech']);
        }

        if (!keyExist('footer')) {
            Setting::create([
                'key' => 'footer', 'value' => 'Developed By Hi Tech',
            ]);
        }
        ...
        if (!keyExist('address')) {
            Setting::create([
                'key' => 'address', 'value' => '221B Baker Street, London, UK, NW1 6XE',
            ]);
        }
